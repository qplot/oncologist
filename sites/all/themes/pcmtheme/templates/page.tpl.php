...
?>
  ...
  <script type='text/javascript'>
	...
	<?php
		$slot = "/21688575/ProstateCancer.TheOncologist.com_728x90_Top_HomePage";
		$pagead = arg(0);
	
		switch($pagead){
			case "pcmhome": $slot 				= "/21688575/ProstateCancer.TheOncologist.com_728x90_Top_HomePage"; break;
			case "articles": $slot 			= "/21688575/ProstateCancer.TheOncologist.com_728x90_Top_Articles"; break;
			case "editorials": $slot 		= "/21688575/ProstateCancer.TheOncologist.com_728x90_Top_Editorials"; break;
			case "challengingcases": $slot 	= "/21688575/ProstateCancer.TheOncologist.com_728x90_Top_Challenging_Cases"; break;
			case "pcmmedialibrary": $slot 		= "/21688575/ProstateCancer.TheOncologist.com_728x90_Top_Media_Library"; break;
			case "node":
							if(strpos($classes, 'node-type-page-html') !== false){
								$slot 			= "/21688575/ProstateCancer.TheOncologist.com_728x90_Top_Articles";
							}
              else if(strpos($classes, 'node-type-article') !== false){
                $slot       = "/21688575/ProstateCancer.TheOncologist.com_728x90_Top_Challenging_Cases";
              }
								...
								$slot 			= "/21688575/ProstateCancer.TheOncologist.com_728x90_Top_Media_Library";
							}
							break;
	...
	googletag.defineSlot('<?php print $slot;?>', [728, 90], 'div-gpt-ad-1360785750424-0').addService(googletag.pubads());
	...
	<div id='div-gpt-ad-1360785750424-0' style='width:728px; height:90px; margin:5px auto 5px auto;'>
	<script type='text/javascript'>
...
<div id="page-wrapper"><div id="page">
  ...
  <header id="header" role="banner">
    ...
    <div id="header"><div class="section clearfix">
        ...
        <div id="disclaimer">Supporters of video lectures, roundtables, and other educational materials are individually acknowledged within.
