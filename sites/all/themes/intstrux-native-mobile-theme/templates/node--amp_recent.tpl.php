	...
	<div class="format-cadmus format-highwire">
		...
		<?php if(!empty($abstract)): ?>
			...
			<div class="abstract">
				...
				<?php print preg_replace_callback('@(<a[^>]v*>)([^<]*)(</a>)@i', 'intstrux_native_mobile_theme_shorten_a_text', $abstract);?>
			</div>
		...
		<div class="body">
			...
			<?php
				...
				foreach ($matches[1] as $key => $value){
	        	    ...
	        	    list($width, $height) = getimagesize(DRUPAL_ROOT.'/sites/default/files/'.basename($img));
