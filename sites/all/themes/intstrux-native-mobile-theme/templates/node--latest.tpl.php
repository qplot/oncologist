<?php
  ...
  $abstract = $node->body[$lang][0]['value'];
...
<div onclick="loadPage('node/<?php print $nid;?>');" class="item-article item-pagehtml">
  ...
  <div class="abstract">
    <?php empty($abstract) ? print strip_tags($node->body[$lang][0]['safe_value']) : print strip_tags(str_replace("Background.", "", str_replace("Introduction.", "", $abstract)));?>
  </div>
...
<!--       <a href="<?php print $node->field_latest_pdf_link['und'][0]['value']; ?>">Full Page PDF Here</a>
 -->    </div> 

    <div class="issue">
<table width="100%" border="0">
  <tr>
    <td align="left" style="padding-left: 69px;"><?php print $date; ?></td>
<td align="right"><a href="<?php print $node->field_latest_pdf_link['und'][0]['value']; ?>"><b>Full Page PDF Here</b></a></td>
</tr>
      ...
      <?php
        ...
        foreach ($matches[1] as $key => $value){
          ...
          $height = 0;
                ...
                $uri = DRUPAL_ROOT.'/sites/default/files/'.basename($img);
          if (file_exists($uri)) {
              // Do something
            ...
            $uri = DRUPAL_ROOT.'/sites/default/files/styles/article/public/'.basename($img);
          ...
          if($height <=0){
            ...
            $image_ratio = $width/$height;
                  ...
                  if($image_ratio < 0.70){
                    ...
                    $imagecached = str_replace($value, '/sites/default/files/styles/portrait_image/public/'.basename($img), $imagecached);
                  }
              }
