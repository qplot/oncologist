...
(function($) {
	...
	RoyalSlider.prototype = {
			...
			_onNavItemClick:function(e) {	
				//alert($('.royalControlNavCenterer').index(e.currentTarget));
				//console.log(e.currentTarget);
				this.goTo($(e.currentTarget).text()-1, false , true);
				//$('li').index(listItem)	
			},
	...
	$.fn.royalSlider.defaults = {    
			...
			dragUsingMouse:false,					// Drag using mouse on non-touch devices
			...
			autoScaleSlider:false,                 // Overrides css slider size settings. Sets slider height based on base width and height. Don't forget to set slider width to 100%.
	   		autoScaleSliderWidth: 700,              // Base slider width
	   		autoScaleSliderHeight: 200,             // Base slider height
