...
if(!empty($abstract))
		$abstract = bcmtheme_filter_abstract($abstract);
...
<?php if(!empty($abstract)): ?>
	...
	<?php print preg_replace_callback('@(<a[^>]*>)([^<]*)(</a>)@i', 'bcmtheme_shorten_a_text', $abstract);?>
	</div>
...
$shortened = preg_replace_callback('@(<a[^>]*>)([^<]*)(</a>)@i', 'bcmtheme_shorten_a_text', $body);
