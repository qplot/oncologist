...
function showAudioPlayer(filepath, title, speaker, description,parentdiv){
	...
	var audioplayer_html = '<object id="flashObj" width="290" height="25" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,47,0">'; 
	audioplayer_html += '<param name="movie" value="https://secure.brightcove.com/services/viewer/federated_f9?isVid=1&isUI=1" />';
	audioplayer_html += '<param name="bgcolor" value="#FFFFFF" />';
	audioplayer_html += '<param name="flashVars" value="playerID=2193607079001&playerKey=AQ~~,AAABygfs89k~,Glyk08Otwu1YMwwxWK0lZKNAY4XnOdFm&domain=embed&dynamicStreaming=true&@videoPlayer='+filepath+'" />';
	audioplayer_html += '<param name="base" value="http://admin.brightcove.com" />';
	audioplayer_html += '<param name="seamlesstabbing" value="false" />';
	audioplayer_html += '<param name="allowFullScreen" value="true" />'; 
	audioplayer_html += '<param name="swLiveConnect" value="true" />'; 
	audioplayer_html += '<param name="allowScriptAccess" value="always" />';
	audioplayer_html += '<param name="secureConnections" value="true" /> ';
	audioplayer_html += '<embed src="https://secure.brightcove.com/services/viewer/federated_f9?isVid=1&isUI=1" bgcolor="#FFFFFF" flashVars="playerID=2193607079001&playerKey=AQ~~,AAABygfs89k~,Glyk08Otwu1YMwwxWK0lZKNAY4XnOdFm&domain=embed&dynamicStreaming=true&@videoPlayer='+filepath+'" base="http://admin.brightcove.com" name="flashObj" width="290" height="25" secureConnections="true" seamlesstabbing="false" type="application/x-shockwave-flash" allowFullScreen="true" allowScriptAccess="always" swLiveConnect="true" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"></embed>';
	audioplayer_html += '</object>';	
