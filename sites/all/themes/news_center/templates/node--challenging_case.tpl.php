...
<?php
	...
	drupal_add_js(array('challengingcase' => array('uid' => $user->uid)), 'setting');
...
<div class="challenging_case">
	...
	<div class="cc_page" id="cc_page_tab1"><?php print '<h3 class="case-title">'.$title.'</h3><br><br>'; echo $case_html; ?>
    ...
    <div class="cc_page" id="cc_page_tab2" style="display:none">
        ...
        <div class="cc_kol_body">
        	...
        	<?php print '<h3 class="case-title">'.$title.'</h3><br><br>';
        	print $pro_html;?></div>
    ...
    <div class="cc_page" id="cc_page_tab3" style="display:none">
        ...
        <div class="cc_kol_body"><?php print '<h3 class="case-title">'.$title.'</h3><br><br>'; print $con_html;?></div>
